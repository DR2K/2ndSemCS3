package trees201819;//(c) A+ Computer Science
...
class BinarySearchTree_NumWidth
{
	private TreeNode root;

	public BinarySearchTree_NumWidth()
	{
		root = null;
	}
...
public class NumWidth
{
   public static void main( String args[] )
   {
	   BinarySearchTree_NumWidth tree = new BinarySearchTree_NumWidth();
