...
class BinarySearchTree_AddPrintOne_Sol {
    private TreeNode root;

    public BinarySearchTree_AddPrintOne_Sol() {
        root = null;
    }
...
public class AddPrintOne_Sol {
    public static void main(String args[]) {
        BinarySearchTree_AddPrintOne_Sol tree = new BinarySearchTree_AddPrintOne_Sol();
