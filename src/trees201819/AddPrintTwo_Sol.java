...
class BinarySearchTree_AddPrintTwo_Sol
{
	private TreeNode root;

	public BinarySearchTree_AddPrintTwo_Sol()
	{
		root = null;
	}
...
public class AddPrintTwo_Sol
{
   ...
   {
	   BinarySearchTree_AddPrintTwo_Sol tree = new BinarySearchTree_AddPrintTwo_Sol();
